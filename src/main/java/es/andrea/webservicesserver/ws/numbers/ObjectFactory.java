 ...
 * generated in the es.andrea.webservicesserver.ws.numbers package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.andrea.webservicesserver.ws.numbers
     * 
     */
